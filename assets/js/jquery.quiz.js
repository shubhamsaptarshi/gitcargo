!(function (a, b, c, d) {
    ...
    (a.quiz = function (b, d) {
        ...
        console.log(JSON.stringify(e.options.questions));
        ...
        (e.methods = {
            ...
            setup: function () {
                ...
                (b += "</div>"),
                0 < a(k).length && e.$el.html('<div id="quiz-start-screen"><p><a href="#" id="quiz-start-btn" class=" mt-5 quiz-button btn btn-primary ">Start</a></p></div>');
                ...
                (b += '<a href="#" class="btn btn-primary btn-sm" id="quiz-next-btn">Next</a>'),
                (b += '<a href="#" class="btn btn-primary btn-sm" style="display:none" id="quiz-finish-btn">Finish</a>'),
                (b += '<a href="#" class="btn btn-primary btn-sm" style="display:none" id="quiz-restart-btn">Restart</a>'),
                (b += "</div>"),
                (b += "</div>"),
