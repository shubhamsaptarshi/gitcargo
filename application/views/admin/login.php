<!DOCTYPE html>
  ...
  <head>
    ...
    <link rel="icon" href="<?php echo base_url();?>assets/admin/images/icon.ico" type="image/x-icon"/>
    <!-- Fonts and icons -->
               ...
               <form class="" id="login_form" name="login_form">
                <div class="card-body pb-0">
                  <div class="form-group">
                    <label for="email2">Email Password</label>
				  ...
				  <div class="form-group text-center">
					<label for="password">Forgot password? <a href="<?php echo base_url();?>admin/Password/">Click here</a></label>
					 </div>
                </div>
                  </form>
              </div>
